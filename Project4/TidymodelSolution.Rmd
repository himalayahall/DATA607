...
data_recipe <- data_recipe %>%
                ...
                update_role(id, n_words, new_role = "REF") %>%
                ...
                # tf-idf encoding is iyet another option
...
-   **AUC** refers to the Area Under the Curve of a
    Receiver Operating Characteristic curve (ROC-AUC). This metric is equal
    to the probability that a classifier will rank a random positive sample
