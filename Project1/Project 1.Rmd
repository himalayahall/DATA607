...
mPlayersAndGames <- unlist(input_matrix[seq(1, length(input_matrix), 3)], use.names = FALSE)
```
...
mStatesAndRanks <- unlist(input_matrix[seq(2, length(input_matrix), 3)], use.names = FALSE)
```
