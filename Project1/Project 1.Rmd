...
Lets take a look at the final results. As final sanity check, notice there is data for 64 players and data for KENNETH matches earlier validations.
...
```{r generate-csv}
write.csv(result_df, "player_analysis.csv", row.names = FALSE)  # write csv, skip row names since it's same as player id
```
