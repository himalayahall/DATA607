...
Next observation is that data for a player is provided in 2 separate rows. First row gives the name of player and games played by them. The second row gives the State and starting rank. For any given player the two rows appear consecutively, followed by a deshed separator line.   
