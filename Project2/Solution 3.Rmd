...
Let's load the data set. This is a small data set with the following untidy characteristics:
...
We see that **mango** is the cheapest fruit (not in the USA!) with the highest calories. Bannana (misspelt) is second with same price but fewer calories.
...
min_df %>%                                       
    ...
    slice_max(calories, n = 2) # select up to 50% items
```
