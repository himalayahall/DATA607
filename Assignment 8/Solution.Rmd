...
First load the JSON file. As expected, the resulting data frame has 3 observation of 5 variables.
...
Next, we load the same data in XML format. Note, both JSON and XML data frames are very similar (same nu)
...
Finally, the same data is loaded in HTML fromat.
