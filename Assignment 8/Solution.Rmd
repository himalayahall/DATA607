...
Next, we load the same data in XML format. Note, both JSON and XML data frames are very similar. However, unlike the JSON version, here the *pages* data type is *chr* (string).
